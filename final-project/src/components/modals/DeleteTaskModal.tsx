...
export default function DeleteTaskModal({screenWidth}:{screenWidth:number}) {
    ...
    return (
        <div>
            <Modal open={modalState.opened && modalState.type === "deleteTask"} onClose={() => dispatch(closeModal())}>
                <Box sx={style}>
                    <Box >
                        ...
                        <Typography sx={{ color: themes[themeMode].drawerText }}>Are you sure you want to delete the '{selectedCard.name}' board? This action will remove all columns and tasks and cannot be reversed.</Typography>
